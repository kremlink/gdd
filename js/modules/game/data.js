export const data={
 ...
 data:{
  'easy':{
   text:'Легко',
   trashData:[{type:2,subtype:18,left:'30%',trs:'3s linear 1s'},{type:2,subtype:18,left:'10%',trs:'5s linear 2s'},
    {type:1,subtype:20,left:'30%',trs:'4s linear 3.5s'},{type:3,subtype:20,left:'35%',trs:'2s linear 5s'},{type:2,subtype:18,left:'70%',trs:'8s linear 5s'},
    {type:3,subtype:20,left:'50%',trs:'6s linear 5s'},{type:1,subtype:20,left:'30%',trs:'3s linear 7s'}],
